...
function Product(props) {
    ...
    let [quantity, setquantity] = useState(props.productDetails.quantity?props.productDetails.quantity:0);
    let [hasProductAdded, sethasProductAdded] = useState(props.productDetails.quantity?true:false);
